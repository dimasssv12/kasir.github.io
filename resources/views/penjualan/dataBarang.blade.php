    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-shopping-cart mr-2"></i> Data Barang</h5>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <form action="/{{auth()->user()->level}}/penjualan/store" method="POST">
                                            ...
                                            @if($item->stok <= 0)
                                            <td><button type="submit" id="tambah" class="btn btn-sm btn-success"
                                                    disabled><i class="fa fa-plus"></i></button></td>
                                            @endif
                                            @if($item->stok > 0)
