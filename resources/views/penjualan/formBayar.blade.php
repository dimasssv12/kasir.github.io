    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="fas fa-money-check-alt mr-2"></i>Transaksi Pembayaran</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="/{{auth()->user()->level}}/penjualan/bayar/{{$nomor}}" method="POST" id="form-penjualan">
                            ...
                            <button type="button" class="btn m-1 btn-primary float-right" data-toggle="modal" onclick="simpan()">Bayar</button>
                        </form>
                    </div>
                </div>
            </div>
