        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header" style="background-color: #008DDA">
                        <h4 class="text-dark">Penjualan Kasir</h4>
                        <div class="card-header-form float-right">
                            <button type="button" class="btn btn-sm btn-outline-warning" data-toggle="modal"
                                data-target="#data-barang"><i class="fas fa-plus"></i> <span
                                    style="color: #000000;">Tambah</span></button>
                        </div>
                    </div>
                    <div class="card-body p-2">
                        ...
                        <div class="card-header bg-warning" >
                            <h4 class="text-dark mb-2">Keranjang Pembayaran</h4>
                        </div>
