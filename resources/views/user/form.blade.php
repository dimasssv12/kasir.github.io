    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title"><i class="fas fa-user-plus mr-2"></i> Tambah Data User</h5>
            ...
            <div class="modal-body">
                <form action="/{{auth()->user()->level}}/user/store" method="POST">
                    ...
                    <button type="submit" class="btn btn-success"><i class="fas fa-user-plus mr-2"></i> Tambah</button>
                </form>
            </div>
        </div>
    </div>
